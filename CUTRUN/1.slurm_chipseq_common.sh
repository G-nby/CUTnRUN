...
/Share/home/gby/CUTnRUN/newscripts/2.ChIPseq_common.sh ${file_prefix} $1 ${SEorPE} ${add_bowtie2_index} ${add_genome_index} ${clean_string} ${add_bw_script} ${blacklist} ${genomesize}
