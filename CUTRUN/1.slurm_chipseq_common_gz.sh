...
/Share/home/lht/lilab_users/4.LYM/gby_cutrun/2.ChIPseq_common_gz.sh ${file_prefix} $1 ${SEorPE} ${add_bowtie2_index} ${add_genome_index} ${clean_string} ${add_bw_script} ${blacklist} ${genomesize}
