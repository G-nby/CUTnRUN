...
if [ $2 == 'ensembl_hg38' ]; then
        ...
        star_index='/Share/home/gby/datalht/Ensembl_genome/GRCh38/STAR_index_GRCh38'
        ...
        star_index='/Share/home/gby/datalht/Ensembl_genome/GRCm38/STAR_index_mm10'
...
/Share/home/gby/CUTnRUN/newscripts/spikein/1.1ChIPseq_spikein.sh ${file_prefix} $1 ${SEorPE} ${star_index} ${add_genome_index} ${clean_string} ${add_bw_script} ${blacklist} ${genomesize} ${add_bowtie2_index}
