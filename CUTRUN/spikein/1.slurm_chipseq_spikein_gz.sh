#!/bin/bash 
#SBATCH -J ChIP_spikein
#SBATCH -p Acluster 
#SBATCH -n 16
#SBATCH --output=%j.out 
#SBATCH --error=%j.err 

count=`ls *.f*q.gz | wc -l`
...
if [ $2 == 'ensembl_hg38' ]; then
        ...
        star_index='/Data/lht/lilab_users/25.GBY/Ensembl_genome/GRCh38/STAR_index_GRCh38'
        add_bw_script='/Share/home/lht/lilab_users/4.LYM/gby_cutrun/bam_to_tsv_GRCh38.sh'
        ...
        star_index='/Data/lht/lilab_users/25.GBY/Ensembl_genome/GRCm38/STAR_index_mm10'
        add_bw_script='/Share/home/lht/lilab_users/4.LYM/gby_cutrun/bam_to_tsv_GRCm38.sh' 
...
/Share/home/lht/lilab_users/4.LYM/gby_cutrun/spikein/1.1ChIPseq_spikein_gz.sh  ${file_prefix} $1 ${SEorPE} ${star_index} ${add_genome_index} ${clean_string} ${add_bw_script} ${blacklist} ${genomesize} ${add_bowtie2_index} ${cpu_num}
